...
![cargo](https://repo.x-cmd.io/cargo.svg?lang=zh)
...
合计: **317,789** 行代码（覆盖前 5 种语言、共 **2450** 个文件）。
...
- **Star**: 15,463 · **Fork**: 3,041 · **开放 issue**: 8,294 · **贡献者**: 1,188

## 累计统计

- **发布数**: 0 · **已合并 PR**: 7471 · **开放 PR**: 92 · **已关闭 issue**: 6715 · **开放 issue**: 1579 · **提交数**: 23194
...
在 [repology.org](https://repology.org/project/cargo) 上共有 **107** 个发行版报告此项目。**4** 个 ✅ 已是最新上游版本，**65** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T06:07:45Z._
